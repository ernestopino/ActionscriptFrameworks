package idv.cjcat.stardust.common.particles {
	...
	public class ParticleList implements ParticleCollection {
		 ...
		 */
		public function ParticleList(particleType:Boolean = TWO_D) {
			head = tail = null;
			count = 0;
			
			if (particleType) sorter = Particle2DListSorter.getInstance();
			else sorter = Particle3DListSorter.getInstance();
		}
