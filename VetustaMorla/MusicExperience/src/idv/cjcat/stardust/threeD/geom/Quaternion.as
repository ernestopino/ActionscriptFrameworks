package idv.cjcat.stardust.threeD.geom {
	...
	public class Quaternion {
		 ...
		 * @param	z
		 */
		public function set(w:Number, x:Number, y:Number, z:Number):Quaternion {
			this.w = w;
			this.x = x;
			this.y = y;
			this.z = z;
		 ...
		 * @return
		 */
		public function setFromAxisRotation(axis:Vec3D = null, angle:Number = 0, useDegree:Boolean = true):Quaternion {
		 ...
		 * @return
		 */
		public function preMultiply(lhs:Quaternion):Quaternion {
		 ...
		 * @return
		 */
		public function preMultiplyThis(lhs:Quaternion):Quaternion {
		 ...
		 * @return
		 */
		public function postMultiply(rhs:Quaternion):Quaternion {
		 ...
		 * @return
		 */
		public function postMultiplyThis(rhs:Quaternion):Quaternion {
		 ...
		 * @return
		 */
		public function nearEquals(q:Quaternion, error:Number = 0.0001):Boolean {
			var dw:Number = w - q.w;
			var dx:Number = x - q.x;
			var dy:Number = y - q.y;
			var dz:Number = z - q.z;
		...
		public function conjugateThis():Quaternion {
			return set(w, -x, -y, -z);
		}
