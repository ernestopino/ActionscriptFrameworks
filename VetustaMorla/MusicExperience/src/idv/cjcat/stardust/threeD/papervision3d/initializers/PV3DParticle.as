package idv.cjcat.stardust.threeD.papervision3d.initializers {
	...
	/**
	 * Assign a <code>Particle</code> object to the <code>target</code> properties of a particle. 
	...
	public class PV3DParticle extends Initializer3D {
		...
		override public function initialize(particle:idv.cjcat.stardust.common.particles.Particle):void {
			particle.target = 
