package idv.cjcat.stardust.common.particles {
	...
	public class ParticleFactory implements InitializerCollector {
		 ...
		 * @return
		 */
		public final function createParticles(count:int):ParticleList {
			...
			for each (var initializer:Initializer in initializerCollection.initializers) {
				initializer.doInitialize(particles);
			}
			return particles;
		}
