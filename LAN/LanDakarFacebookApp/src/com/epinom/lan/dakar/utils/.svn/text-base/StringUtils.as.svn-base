	...
	*/
	...
	public class StringUtils {
		...
		*/
		...
		/**
		 * Devuelve el dia de la semana pasandole un entero
		 * 
		 * @param	Index del dia de la semana
		 * @return 	String del dia de la semana
		 */
		public static function getDayByIndex(value:Number):String
		{
			var day:String = "";
			switch(value)
			{
				...
				case 6:
					...
					break;									
				default:
					throw new Error("Indice del dia desconocido");
			}
